        ...
        <div className="min-h-screen flex flex-col bg-white dark:bg-dark-bg transition-colors duration-300">
            ...
            <div className="flex-grow w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-12">
                ...
                <main className="lg:col-span-8 min-h-[60vh]">
                    <article className="fade-in bg-white dark:bg-dark-card sm:rounded-2xl sm:border border-stone-100 dark:border-dark-border sm:shadow-sm p-0 sm:p-8">
                        ...
                        <header className="mb-8 px-4 sm:px-0 pb-8 border-b border-stone-100 dark:border-white/10">
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-10 h-10 rounded-full flex items-center justify-center overflow-hidden border border-stone-200 dark:border-stone-700">
                        ...
                        {/* Interactions */}
                        <div className="px-4 sm:px-0 py-8 border-t border-stone-100 dark:border-white/10">
